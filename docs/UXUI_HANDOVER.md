...
*This document should be reviewed and updated as the design evolves. All design decisions should be documented in the design file for developer reference.*
