...
export const authenticate = (req, res, next) => {
  try {
    ...
    console.log('[AuthMiddleware] Auth header:', authHeader ? authHeader.substring(0, 30) + '...' : 'none');
    ...
    req.user = decoded;
    console.log('[AuthMiddleware] Authentication successful for user:', decoded.userId);
    next();
  } catch (error) {
