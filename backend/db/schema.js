 ...
 */
export const VALID_ACTIVITY_TYPES = ['running', 'squats', 'pushups', 'pullups', 'other'];

/**
 * Achievement categories
 */
export const ACHIEVEMENT_CATEGORIES = ['streak', 'personal_record', 'milestone', 'consistency'];
